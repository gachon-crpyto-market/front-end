    ...
    <div className="min-w-[72rem] h-[calc(100vh-7rem)] bg-gray-100 flex place-items-center justify-center">
      ...
      <div className="w-1/3 h-2/3 bg-white rounded-lg m-4">
        <div className="w-full p-4 bg-white rounded-t-lg border-b-[1px] border-gray-200">
          <p className="text-xl font-bold w-full ">Welcom to Team 씨쁠</p>
        </div>
        <div className="p-5 bg-white">
          ...
          <p className="w-full text-right pr-1 text-xs text-yellow-500">Forgot password</p>
          ...
          <p className="w-full text-center mt-8 text-xs text-gray-400">Don't have an account? <span className="text-yellow-500 cursor-pointer" onClick={handleSignUpClick}>Sign Up</span></p>
